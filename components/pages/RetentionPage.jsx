...
import { Search, Loader2, IndianRupee, Clock, AlertCircle, CheckCircle2, FileText, Calendar, Download } from "lucide-react"
...
export default function RetentionPage({ user }) {
  ...
  const handleExport = () => {
    exportToExcel(filteredData, `RetentionTracker`)
  }
    ...
    <div className="space-y-6">
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Button variant="outline" size="sm" onClick={handleExport} className="flex items-center gap-2 w-fit">

...
export default function AccountsApprovalPage({ user }) {
  ...
  const handleExport = () => {
    const dataToExport = activeTab === "pending" ? rows : historyRows
    exportToExcel(dataToExport, `AccountsApproval_${activeTab}`)
  }
  ...
  const displayRows = useMemo(() => {
    let source = activeTab === "pending" ? rows : historyRows
  ...
  }, [activeTab, rows, historyRows, searchTerm, filterFirm, filterParty])

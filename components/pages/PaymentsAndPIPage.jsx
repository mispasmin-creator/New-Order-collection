...
import {
  Search, Loader2, CheckCircle2, Clock, IndianRupee, FileText, AlertCircle, ChevronDown, ChevronRight, RefreshCw, Download
} from "lucide-react"
...
export default function PaymentsAndPIPage({ user }) {
  ...
  const handleExport = () => {
    exportToExcel(displayOrders, `PaymentsAndPI_${activeTab}`)
  }
